...
function buildDefaultSeedData(): AppState {
  ...
  const defaultUsers: User[] = [
    { id: uAdminId, nombre: 'WASHINGTON QUIÑONES', email: 'ibpsiglesiadiamante@gmail.com', pass: 'admin123', rol: 'admin', codigo: 'ADM-001', creado: now() },
    { id: 'admin-synapsis-id', nombre: 'Administrador Synapsis', email: 'admin@synapsis.edu', pass: 'admin123', rol: 'admin', codigo: 'ADM-002', creado: now() },
    { id: uDocenteId, nombre: 'Prof. de Jesús María García', email: 'juan.docente@synapsis.edu', pass: 'docente123', rol: 'docente', codigo: 'DOC-001', creado: now() },
    { id: uEstudiante1Id, nombre: 'Carlos Andrés Pérez', email: 'maria.estudiante@synapsis.edu', pass: 'estudiante123', rol: 'estudiante', codigo: 'EST-001', creado: now() },
    { id: uEstudiante2Id, nombre: 'Ana Isabel Rodríguez', email: 'ana.estudiante@synapsis.edu', pass: 'estudiante123', rol: 'estudiante', codigo: 'EST-002', creado: now() },
  ];
